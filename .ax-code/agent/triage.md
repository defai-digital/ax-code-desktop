...
mode: primary
hidden: true
model: ax-code-go/deepseek-v4-flash
color: "#c4920a"
permission:
  edit: deny
  bash:
...
- Web: web server, HTTP/SSE APIs, AX Code server integration, filesystem routes, Git/GitHub/quota/notification/terminal/TTS/skills modules.
