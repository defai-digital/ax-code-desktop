# <img src="../../logo/apple-icon.png" width="32" height="32" align="absmiddle" /> AX Code App Desktop
...
- **Remote instances over SSH** - connect to remote AX Code App servers with dedicated lifecycle and UX flows
