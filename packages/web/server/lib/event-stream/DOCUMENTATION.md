...
## Purpose
This module contains the OpenChamber message-stream WebSocket protocol and runtime bridge. It keeps the browser-facing WebSocket transport separate from the upstream AX Code SSE transport.
...
- OpenChamber still fetches AX Code upstream event streams over SSE.
