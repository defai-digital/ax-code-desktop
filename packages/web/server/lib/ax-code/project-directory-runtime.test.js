...
describe('project directory runtime', () => {
  ...
  describe('resolveProjectDirectory', () => {
    it('resolves symlinks in x-ax-code-directory header', async () => {
      const runtime = createTestRuntime({
        fsPromises: {
          stat: async () => ({ isDirectory: () => true }),
      ...
      const req = {
        get: (header) => header === 'x-ax-code-directory' ? '/home/user/workspace/project' : null,
        query: {},
      };
  ...
  describe('resolveOptionalProjectDirectory', () => {
    ...
    it('resolves symlinks when directory is provided', async () => {
      ...
      const req = {
        get: (header) => header === 'x-ax-code-directory' ? '/symlink/workspace/project' : null,
        query: {},
      };
