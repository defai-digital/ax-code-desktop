...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'O AX Code Desktop',
  ...
  'chat.emptyState.axCodeUnreachable': 'AX Code jest nieosiągalny',
  ...
  'chat.draftPresets.summarise.label': 'Podsumuj kod',
  'chat.draftPresets.findBugs.label': 'Znajdź błędy w ostatnich commitach',
  'chat.draftPresets.writeTests.label': 'Napisz testy dla ostatnich zmian',
  'chat.projectKnowledge.loaded': 'CLAUDE.md załadowany',
  'chat.projectKnowledge.create': 'Utwórz CLAUDE.md',
  ...
  'chat.activity.aria': 'Aktywność agenta: {label}',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia AX Code Desktop.',
  ...
  'onboarding.chooser.title': 'Witaj w AX Code Desktop',
  ...
  'onboarding.localSetup.title': 'Konfiguracja AX Code',
  'onboarding.localSetup.description': 'Zainstaluj CLI AX Code aby kontynuować.',
  'onboarding.localSetup.dialog.selectAxCodeBinary': 'Wybierz binarkę ax-code',
  'onboarding.localSetup.errors.cliNotReady': 'AX Code CLI nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli AX Code Desktop nie wykryje AX Code automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij aby sprawdzić czy AX Code CLI jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Juz zainstalowane? Ustaw ścieżkę binarki AX Code:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień AX Code Desktop i przeładowuje konfigurację AX Code.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'W Windows, zainstaluj i uruchom AX Code w WSL dla najlepszej kompatybilności.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'Jeśli wykrywanie nie powiedzie się, ustaw natywną ścieżkę (ax-code.cmd/ax-code.exe), wsl.exe, lub wsl:/usr/local/bin/ax-code.',
  'onboarding.localSetup.hint.ensurePath': 'Juz zainstalowane? Upewnij się, że ax-code jest w twoim PATH.',
  'onboarding.localSetup.hint.setEnv': 'Lub ustaw zmienną środowiskową AX_CODE_BINARY.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera AX Code Desktop aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer AX Code Desktop, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim AX Code Desktop. Zweryfikuj czy adres wskazuje na serwer AX Code Desktop.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'AX Code lokalny niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie można było uruchomić AX Code CLI lub nie jest zainstalowany. Zainstaluj AX Code lub połącz się z serwerem zdalnym.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia AX Code Desktop. Zweryfikuj czy adres wskazuje na serwer AX Code Desktop.',
  ...
  'startup.initRecovery.description': 'AX Code Desktop nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan AX Code Desktop, kondycję AX Code, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja AX Code Desktop {version}',
  'aboutDialog.axCodeVersionLabel': 'Wersja AX Code {version}',
  ...
  'chat.chatInput.executionMode.title': 'Tryb wykonywania',
  'chat.chatInput.executionMode.manual': 'Ręczny',
  'chat.chatInput.executionMode.autonomous': 'Autonomiczny',
  'chat.chatInput.executionMode.longRun': 'Długie działanie',
  'chat.chatInput.executionMode.manualHint': 'Ty zatwierdzasz ryzykowne kroki',
  'chat.chatInput.executionMode.autonomousHint': 'Automatycznie zatwierdza bezpieczne narzędzia; kontynuuje wieloetapowe uruchomienia',
  'chat.chatInput.executionMode.longRunHint': 'Autonomiczny, do 72 godz. z regulacją tempa',
  'chat.chatInput.executionMode.updateFailed': 'Nie udało się zaktualizować trybu wykonywania',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do AX Code Desktop — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami AX Code Desktop',
  ...
  'header.actions.openAppMenu': 'Menu AX Code Desktop',
  'header.actions.openAppMenuAria': 'Otwórz menu AX Code Desktop',
  ...
  'header.services.shutdownDev': 'Zatrzymaj AX Code Desktop',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po AX Code Desktop.',
  ...
  'mcpDropdown.empty.configureInConfig': 'Skonfiguruj serwery MCP w konfiguracji AX Code.',
  ...
  'memoryDebugPanel.streaming.copy.hint': 'Kopiowanie eksportuje metryki streamingu UI w formacie JSON',
  ...
  'openChamberLogo.aria.logo': 'Logo AX Code Desktop',
  'axCodeStatusDialog.actions.copy': 'Kopiuj',
  'axCodeStatusDialog.description': 'Sprawdź bieżący status i diagnostykę AX Code.',
  'axCodeStatusDialog.empty.noData': 'Brak danych.',
  'axCodeStatusDialog.title': 'Status AX Code',
  'axCodeStatusDialog.toast.copiedDescription': 'Status skopiowany do schowka',
  'axCodeStatusDialog.toast.copiedTitle': 'Skopiowano',
  'axCodeStatusDialog.toast.copyFailed': 'Nie udało się skopiować statusu',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj AX Code Desktop',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: ax-code-desktop update',
  ...
  'updateDialog.header.updating': 'Aktualizowanie AX Code Desktop...',
  ...
  'axCodeUpdate.toast.available.title': 'Aktualizacja AX Code',
  'axCodeUpdate.toast.available.description': 'Wersja {version} dostępna.',
  'axCodeUpdate.toast.actions.update': 'Aktualizuj',
  'axCodeUpdate.toast.actions.dismiss': 'Odrzuć',
  'axCodeUpdate.toast.actions.reload': 'Przeładuj AX Code',
  'axCodeUpdate.toast.upgrading.title': 'Aktualizowanie AX Code...',
  'axCodeUpdate.toast.upgrading.description': 'Pozostaw AX Code Desktop otwarte.',
  'axCodeUpdate.toast.updated.title': 'AX Code zaktualizowany',
  'axCodeUpdate.toast.updated.description': 'Aktualizacja zainstalowana.',
  'axCodeUpdate.toast.updated.descriptionWithVersion': 'Wersja {version} zainstalowana.',
  'axCodeUpdate.toast.failed.title': 'Nie udało się zaktualizować AX Code',
  'axCodeUpdate.toast.failed.description': 'Aktualizacja AX Code nie powiodła się.',
  'axCodeUpdate.toast.reload.message': 'Ponowne uruchamianie AX Code...',

  // Onboarding
  'onboarding.localSetup.actions.checkAndContinue': 'Sprawdź i kontynuuj',
  'onboarding.localSetup.intro': 'AX Code to serce AX Code Desktop — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na AX Code',
  ...
  'gitView.sync.commitOrStashTooltip': 'Zacommituj lub schowaj zmiany przed pull.',
  ...
  'gitView.toast.commitOrStashBeforeSync': 'Zacommituj lub schowaj zmiany przed pull',
  'gitView.toast.alreadyUpToDate': 'Już masz najnowszą wersję',
  'gitView.toast.pullBeforePush': 'Najpierw wykonaj pull z {name} ({count} do tyłu)',
