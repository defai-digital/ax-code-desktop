...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'O AX Code App',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia AX Code App.',
  ...
  'onboarding.chooser.title': 'Witaj w AX Code App',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli AX Code App nie wykryje AX Code automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień AX Code App i przeładowuje konfigurację AX Code.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera AX Code App aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer AX Code App, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim AX Code App. Zweryfikuj czy adres wskazuje na serwer AX Code App.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia AX Code App. Zweryfikuj czy adres wskazuje na serwer AX Code App.',
  ...
  'startup.initRecovery.description': 'AX Code App nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan AX Code App, kondycję AX Code, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja AX Code App {version}',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do AX Code App — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami AX Code App',
  ...
  'header.actions.openAppMenu': 'Menu AX Code App',
  'header.actions.openAppMenuAria': 'Otwórz menu AX Code App',
  ...
  'header.services.shutdownDev': 'Zatrzymaj AX Code App',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po AX Code App.',
  ...
  'openChamberLogo.aria.logo': 'Logo AX Code App',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj AX Code App',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: ax-code-app update',
  ...
  'updateDialog.header.updating': 'Aktualizowanie AX Code App...',
  ...
  'axCodeUpdate.toast.upgrading.description': 'Pozostaw AX Code App otwarte.',
  ...
  'onboarding.localSetup.intro': 'AX Code to serce AX Code App — zainstaluj je, aby zacząć.',
