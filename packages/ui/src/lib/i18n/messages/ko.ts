...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'AX Code App 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 AX Code App에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'AX Code App 종료',
  ...
  'aboutDialog.openChamberVersionLabel': 'AX Code App 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'AX Code App 상태, AX Code 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 AX Code App를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'AX Code App 메뉴',
  'header.actions.openAppMenuAria': 'AX Code App 메뉴 열기',
  ...
  'sessionAuth.locked.unlockTitle': 'AX Code App 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 AX Code App 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'AX Code App 멀티런 창.',
  ...
  'onboarding.chooser.title': 'AX Code App에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'AX Code App가 AX Code를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'AX Code는 AX Code App의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'AX Code App 설정에 저장하고 AX Code 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 AX Code App 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 AX Code App 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 AX Code App가 실행 중이 아닙니다. 주소가 AX Code App 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 AX Code App가 실행 중이 아닙니다. 주소가 AX Code App 서버를 가리키는지 확인하세요.',
  ...
  'startup.initRecovery.description': 'AX Code App 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'AX Code App 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `ax-code-app update`를 실행하세요.',
  ...
  'axCodeUpdate.toast.upgrading.description': 'AX Code App를 열어 두세요.',
