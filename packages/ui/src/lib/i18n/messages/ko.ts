...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'AX Code Desktop 정보',
  ...
  'gitView.sync.commitOrStashTooltip': 'Pull하기 전에 변경 사항을 커밋하거나 stash하세요',
  ...
  'gitView.toast.commitOrStashBeforeSync': 'Pull하기 전에 변경 사항을 커밋하거나 stash하세요',
  'gitView.toast.alreadyUpToDate': '이미 최신 상태입니다',
  'gitView.toast.pullBeforePush': '{name}에서 먼저 Pull하세요({count}개 뒤처짐)',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 AX Code Desktop에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'AX Code Desktop 종료',
  ...
  'aboutDialog.openChamberVersionLabel': 'AX Code Desktop 버전 {version}',
  'aboutDialog.axCodeVersionLabel': 'AX Code 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'AX Code Desktop 상태, AX Code 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 AX Code Desktop를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'AX Code Desktop 메뉴',
  'header.actions.openAppMenuAria': 'AX Code Desktop 메뉴 열기',
  ...
  'chat.emptyState.axCodeUnreachable': 'AX Code에 연결할 수 없음',
  ...
  'chat.draftPresets.summarise.label': '코드베이스 요약',
  'chat.draftPresets.findBugs.label': '최근 커밋에서 버그 찾기',
  'chat.draftPresets.writeTests.label': '최근 변경 사항에 대한 테스트 작성',
  'chat.projectKnowledge.loaded': 'CLAUDE.md 로드됨',
  'chat.projectKnowledge.create': 'CLAUDE.md 생성',
  ...
  'chat.activity.aria': '에이전트 활동: {label}',
  ...
  'chat.chatInput.executionMode.title': '실행 모드',
  'chat.chatInput.executionMode.manual': '수동',
  'chat.chatInput.executionMode.autonomous': '자율',
  'chat.chatInput.executionMode.longRun': '장기 실행',
  'chat.chatInput.executionMode.manualHint': '위험한 단계는 직접 승인합니다',
  'chat.chatInput.executionMode.autonomousHint': '안전한 도구를 자동 승인하고 여러 단계를 계속 진행합니다',
  'chat.chatInput.executionMode.longRunHint': '자율 모드, 최대 72시간, 속도 조절 포함',
  'chat.chatInput.executionMode.updateFailed': '실행 모드를 업데이트하지 못했습니다',
  ...
  'axCodeStatusDialog.title': 'AX Code 상태',
  'axCodeStatusDialog.description': '현재 AX Code 상태와 진단 정보를 확인합니다.',
  'axCodeStatusDialog.actions.copy': '복사',
  'axCodeStatusDialog.empty.noData': '데이터가 없습니다',
  'axCodeStatusDialog.toast.copiedTitle': '복사됨',
  'axCodeStatusDialog.toast.copiedDescription': '상태를 클립보드에 복사했습니다',
  'axCodeStatusDialog.toast.copyFailed': '상태 복사에 실패했습니다',
  ...
  'mcpDropdown.empty.configureInConfig': 'AX Code 설정에서 MCP 서버를 구성하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'AX Code Desktop 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 AX Code Desktop 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'AX Code Desktop 멀티런 창.',
  ...
  'onboarding.chooser.title': 'AX Code Desktop에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.title': 'AX Code 설정',
  'onboarding.localSetup.description': '계속하려면 AX Code CLI를 설치하세요.',
  'onboarding.localSetup.dialog.selectAxCodeBinary': 'ax-code 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'AX Code CLI가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'AX Code Desktop가 AX Code를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'AX Code는 AX Code Desktop의 심장입니다. 먼저 설치하고 시작하세요.',
  'onboarding.localSetup.docs.windows': 'AX Code Windows + WSL 문서',
  'onboarding.localSetup.docs.default': 'AX Code 문서',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'AX Code CLI를 사용할 수 있으면 확인을 누르세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': 'AX Code 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? AX Code CLI 경로 설정:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'AX Code Desktop 설정에 저장하고 AX Code 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 최상의 호환성을 위해 WSL에서 AX Code를 설치하고 실행하세요.',
  'onboarding.localSetup.windows.hintDetectionFailed': '감지에 실패하면 native 경로(ax-code.cmd/ax-code.exe), wsl.exe 또는 wsl:/usr/local/bin/ax-code를 설정하세요.',
  'onboarding.localSetup.hint.ensurePath': '이미 설치되어 있나요? ax-code가 PATH에 있는지 확인하세요.',
  'onboarding.localSetup.hint.setEnv': '또는 `AX_CODE_BINARY` 환경 변수를 설정하세요.',
  ...
  'onboarding.remoteConnection.description': '연결할 AX Code Desktop 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 AX Code Desktop 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 AX Code Desktop가 실행 중이 아닙니다. 주소가 AX Code Desktop 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 AX Code를 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': 'AX Code CLI를 시작할 수 없거나 설치되어 있지 않습니다. AX Code를 설치하거나 원격 서버에 연결하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 AX Code Desktop가 실행 중이 아닙니다. 주소가 AX Code Desktop 서버를 가리키는지 확인하세요.',
  ...
  'startup.initRecovery.description': 'AX Code Desktop 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'AX Code Desktop 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `ax-code-desktop update`를 실행하세요.',
  'axCodeUpdate.toast.available.title': 'AX Code 업데이트',
  'axCodeUpdate.toast.available.description': '버전 {version} 사용 가능.',
  'axCodeUpdate.toast.actions.update': '업데이트',
  'axCodeUpdate.toast.actions.dismiss': '닫기',
  'axCodeUpdate.toast.actions.reload': 'AX Code 다시 로드',
  'axCodeUpdate.toast.upgrading.title': 'AX Code 업데이트 중...',
  'axCodeUpdate.toast.upgrading.description': 'AX Code Desktop를 열어 두세요.',
  'axCodeUpdate.toast.updated.title': 'AX Code 업데이트 완료',
  'axCodeUpdate.toast.updated.description': '업데이트가 설치되었습니다.',
  'axCodeUpdate.toast.updated.descriptionWithVersion': '버전 {version}이 설치되었습니다.',
  'axCodeUpdate.toast.failed.title': 'AX Code를 업데이트할 수 없음',
  'axCodeUpdate.toast.failed.description': 'AX Code 업그레이드에 실패했습니다.',
  'axCodeUpdate.toast.reload.message': 'AX Code 다시 시작 중...',
  ...
  'memoryDebugPanel.streaming.copy.hint': 'UI 스트리밍 메트릭을 JSON으로 복사합니다',
  ...
  'openChamberLogo.aria.logo': 'AX Code Desktop 로고',
