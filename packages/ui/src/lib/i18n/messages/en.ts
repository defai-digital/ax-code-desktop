...
export const dict = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About AX Code Desktop',
  ...
  'gitView.sync.commitOrStashTooltip': 'Commit or stash your changes before pulling',
  ...
  'gitView.toast.commitOrStashBeforeSync': 'Commit or stash your changes before pulling',
  'gitView.toast.alreadyUpToDate': 'Already up to date',
  'gitView.toast.pullBeforePush': 'Pull from {name} before pushing ({count} behind)',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to AX Code Desktop — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'diffView.comments.summaryTitle': '{count} comments',
  'diffView.comments.send': 'Send to agent',
  'diffView.comments.discard': 'Discard',
  'diffView.comments.sent': 'Comments sent to agent',
  'diffView.comments.sendFailed': 'Failed to send comments',
  'diffView.comments.noSession': 'No active session to send comments',
  ...
  'header.services.shutdownDev': 'Stop AX Code Desktop',
  ...
  'aboutDialog.openChamberVersionLabel': 'AX Code Desktop version {version}',
  'aboutDialog.axCodeVersionLabel': 'AX Code version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes AX Code Desktop state, AX Code health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate AX Code Desktop efficiently',
  ...
  'header.actions.openAppMenu': 'AX Code Desktop menu',
  'header.actions.openAppMenuAria': 'Open AX Code Desktop menu',
  ...
  'chat.doneNotCommitted.message': 'Agent finished with {count} uncommitted files',
  'chat.doneNotCommitted.review': 'Review',
  'chat.doneNotCommitted.commit': 'Commit',
  'chat.doneNotCommitted.dismiss': 'Dismiss',
  ...
  'chat.queuedMessage.heldTitle': 'Held messages',
  'chat.queuedMessage.subtitle': 'will send when turn ends',
  'chat.queuedMessage.held': 'held — agent errored',
  ...
  'chat.chatInput.executionMode.title': 'Execution mode',
  'chat.chatInput.executionMode.manual': 'Manual',
  'chat.chatInput.executionMode.autonomous': 'Autonomous',
  'chat.chatInput.executionMode.longRun': 'Long-run',
  'chat.chatInput.executionMode.manualHint': 'You approve risky steps',
  'chat.chatInput.executionMode.autonomousHint': 'Auto-approves safe tools; continues multi-step runs',
  'chat.chatInput.executionMode.longRunHint': 'Autonomous, up to 72h with pacing',
  'chat.chatInput.executionMode.updateFailed': 'Could not update execution mode',
  'chat.chatInput.sandbox.title': 'Sandbox',
  'chat.chatInput.sandbox.on': 'Sandbox: on',
  'chat.chatInput.sandbox.off': 'Sandbox: off',
  'chat.chatInput.sandbox.updateFailed': 'Could not update sandbox setting',
  ...
  'chat.permissionCard.patternBuilder.title': 'Choose a pattern to always allow:',
  'chat.permissionCard.patternBuilder.custom': 'Custom',
  'chat.permissionCard.patternBuilder.confirm': 'Confirm',
  'chat.permissionCard.patternBuilder.cancel': 'Back',
  'chat.permissionCard.pendingSummary.title': '{count} pending approvals',
  'chat.permissionCard.pendingSummary.openAll': 'View all',
  ...
  'axCodeStatusDialog.title': 'AX Code Status',
  'axCodeStatusDialog.description': 'Inspect current AX Code status and diagnostics.',
  'axCodeStatusDialog.actions.copy': 'Copy',
  'axCodeStatusDialog.empty.noData': 'No data.',
  'axCodeStatusDialog.toast.copiedTitle': 'Copied',
  'axCodeStatusDialog.toast.copiedDescription': 'Status copied to clipboard',
  'axCodeStatusDialog.toast.copyFailed': 'Failed to copy status',
  ...
  'mcpDropdown.empty.configureInConfig': 'Configure MCP servers in AX Code config.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock AX Code Desktop',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote AX Code Desktop servers',
  ...
  'errorBoundary.actions.openStatus': 'Check status',
  'notifications.permission.title': 'Approval needed',
  'notifications.permission.body': 'A session is waiting for your approval',
  'notifications.permission.bodyWithTitle': '{title} is waiting for your approval',
  ...
  'multiRun.window.description': 'AX Code Desktop Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to AX Code Desktop',
  ...
  'onboarding.localSetup.title': 'Setting Up AX Code',
  'onboarding.localSetup.description': 'Install AX Code CLI to continue.',
  'onboarding.localSetup.dialog.selectAxCodeBinary': 'Select ax-code binary',
  'onboarding.localSetup.errors.cliNotReady': 'AX Code CLI is not ready yet. Please confirm installation is complete and try again.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If AX Code Desktop does not detect AX Code automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'AX Code is the heart of AX Code Desktop — install it to get started.',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if AX Code CLI is available. If successful, you\'ll automatically enter the main screen.',
  ...
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the AX Code CLI path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to AX Code Desktop settings and reloads AX Code configuration.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'On Windows, install and run AX Code in WSL for best compatibility.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'If detection fails, set a native path (ax-code.cmd/ax-code.exe), wsl.exe, or wsl:/usr/local/bin/ax-code.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an AX Code Desktop server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an AX Code Desktop server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running AX Code Desktop. Verify the address points to an AX Code Desktop server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.description': 'AX Code CLI could not be started or is not installed. Install AX Code or connect to a remote server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running AX Code Desktop. Verify the address points to an AX Code Desktop server.',
  ...
  'startup.initRecovery.description': 'AX Code Desktop could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating AX Code Desktop...',
  ...
  'axCodeUpdate.toast.actions.dismiss': 'Dismiss',
  'axCodeUpdate.toast.actions.reload': 'Reload AX Code',
  'axCodeUpdate.toast.upgrading.title': 'Updating AX Code...',
  'axCodeUpdate.toast.upgrading.description': 'Keep AX Code Desktop open.',
  'axCodeUpdate.toast.updated.title': 'AX Code updated',
  'axCodeUpdate.toast.updated.description': 'Update installed.',
  'axCodeUpdate.toast.updated.descriptionWithVersion': 'Version {version} installed.',
  ...
  'memoryDebugPanel.streaming.copy.hint': 'Copy UI streaming metrics as JSON',
  ...
  'openChamberLogo.aria.logo': 'AX Code Desktop logo',
