...
export const dict = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About AX Code App',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to AX Code App — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.services.shutdownDev': 'Stop AX Code App',
  ...
  'aboutDialog.openChamberVersionLabel': 'AX Code App version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes AX Code App state, AX Code health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate AX Code App efficiently',
  ...
  'header.actions.openAppMenu': 'AX Code App menu',
  'header.actions.openAppMenuAria': 'Open AX Code App menu',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock AX Code App',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote AX Code App servers',
  ...
  'multiRun.window.description': 'AX Code App Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to AX Code App',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If AX Code App does not detect AX Code automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'AX Code is the heart of AX Code App — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to AX Code App settings and reloads AX Code configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an AX Code App server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an AX Code App server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running AX Code App. Verify the address points to an AX Code App server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running AX Code App. Verify the address points to an AX Code App server.',
  ...
  'startup.initRecovery.description': 'AX Code App could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating AX Code App...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: ax-code-app update',
  ...
  'axCodeUpdate.toast.upgrading.description': 'Keep AX Code App open.',
