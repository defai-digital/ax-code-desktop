...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de AX Code App",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a AX Code App: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "header.services.shutdownDev": "Detener AX Code App",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de AX Code App {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de AX Code App, el estado de AX Code, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por AX Code App de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de AX Code App",
  "header.actions.openAppMenuAria": "Abrir menú de AX Code App",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de AX Code App",
  ...
  "multiRun.window.description": "Ventana de AX Code App Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a AX Code App",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si AX Code App no detecta AX Code automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "AX Code es el corazón de AX Code App. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de AX Code App y recarga la configuración de AX Code.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de AX Code App para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor AX Code App o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando AX Code App. Verifica que la dirección apunte a un servidor AX Code App.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando AX Code App. Verifica que la dirección apunte a un servidor AX Code App.",
  ...
  "startup.initRecovery.description": "AX Code App no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando AX Code App...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: ax-code-app update",
  ...
  "axCodeUpdate.toast.upgrading.description": "Mantén AX Code App abierto.",
