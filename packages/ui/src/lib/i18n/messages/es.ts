...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de AX Code Desktop",
  ...
  "gitView.sync.commitOrStashTooltip": "Haz commit o stash de tus cambios antes de hacer pull",
  ...
  "gitView.sync.pullChanges": "Pull changes",
  "gitView.sync.pullChangesTooltip": "Pull {behind} down",
  "gitView.sync.push": "Push",
  "gitView.sync.pushChanges": "Push changes",
  "gitView.sync.pushChangesTooltip": "Push {ahead} up",
  ...
  "gitView.toast.commitOrStashBeforeSync": "Haz commit o stash de tus cambios antes de hacer pull",
  "gitView.toast.alreadyUpToDate": "Ya está actualizado",
  "gitView.toast.pullBeforePush": "Haz pull desde {name} antes de hacer push ({count} detrás)",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a AX Code Desktop: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "header.services.shutdownDev": "Detener AX Code Desktop",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de AX Code Desktop {version}",
  "aboutDialog.axCodeVersionLabel": "Versión de AX Code {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de AX Code Desktop, el estado de AX Code, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por AX Code Desktop de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de AX Code Desktop",
  "header.actions.openAppMenuAria": "Abrir menú de AX Code Desktop",
  ...
  "chat.emptyState.axCodeUnreachable": "AX Code no es accesible",
  ...
  "chat.draftPresets.summarise.label": "Resumir el código",
  "chat.draftPresets.findBugs.label": "Buscar errores en commits recientes",
  "chat.draftPresets.writeTests.label": "Escribir tests para cambios recientes",
  "chat.projectKnowledge.loaded": "CLAUDE.md cargado",
  "chat.projectKnowledge.create": "Crear CLAUDE.md",
  ...
  "chat.activity.aria": "Actividad del agente: {label}",
  ...
  "chat.chatInput.executionMode.title": "Modo de ejecución",
  "chat.chatInput.executionMode.manual": "Manual",
  "chat.chatInput.executionMode.autonomous": "Autónomo",
  "chat.chatInput.executionMode.longRun": "Larga duración",
  "chat.chatInput.executionMode.manualHint": "Tú apruebas los pasos arriesgados",
  "chat.chatInput.executionMode.autonomousHint": "Aprueba automáticamente herramientas seguras; continúa ejecuciones de varios pasos",
  "chat.chatInput.executionMode.longRunHint": "Autónomo, hasta 72 h con ritmo controlado",
  "chat.chatInput.executionMode.updateFailed": "No se pudo actualizar el modo de ejecución",
  ...
  "axCodeStatusDialog.title": "Estado de AX Code",
  "axCodeStatusDialog.description": "Inspecciona el estado actual de AX Code y diagnósticos.",
  "axCodeStatusDialog.actions.copy": "Copiar",
  "axCodeStatusDialog.empty.noData": "No hay datos.",
  "axCodeStatusDialog.toast.copiedTitle": "Copiado",
  "axCodeStatusDialog.toast.copiedDescription": "Estado copiado al portapapeles",
  "axCodeStatusDialog.toast.copyFailed": "No se pudo copiar el estado",
  ...
  "mcpDropdown.empty.configureInConfig": "Configura los servidores MCP en la configuración de AX Code.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear AX Code Desktop",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de AX Code Desktop",
  ...
  "multiRun.window.description": "Ventana de AX Code Desktop Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a AX Code Desktop",
  ...
  "onboarding.localSetup.title": "Configuración de AX Code",
  "onboarding.localSetup.description": "Instala la CLI de AX Code para continuar.",
  "onboarding.localSetup.dialog.selectAxCodeBinary": "Seleccionar ejecutable de ax-code",
  "onboarding.localSetup.errors.cliNotReady": "La CLI de AX Code aún no está lista. Confirma que la instalación está completa y intenta de nuevo.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si AX Code Desktop no detecta AX Code automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "AX Code es el corazón de AX Code Desktop. Instálalo para empezar.",
  "onboarding.localSetup.docs.windows": "Documentación de AX Code para Windows + WSL",
  "onboarding.localSetup.docs.default": "Documentación de AX Code",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Haz clic para verificar si la CLI de AX Code está disponible. Si la verificación funciona, entrarás automáticamente en la pantalla principal.",
  "onboarding.localSetup.status.watching": "Esperando AX Code",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automáticamente al detectarlo.",
  "onboarding.localSetup.field.alreadyInstalled": "¿Ya está instalado? Establece la ruta de la CLI de AX Code:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de AX Code Desktop y recarga la configuración de AX Code.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta AX Code en WSL para mayor compatibilidad.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Si la detección falla, establece una ruta nativa (ax-code.cmd/ax-code.exe), wsl.exe, o wsl:/usr/local/bin/ax-code.",
  "onboarding.localSetup.hint.ensurePath": "¿Ya está instalado? Asegúrate de que ax-code esté en tu PATH.",
  "onboarding.localSetup.hint.setEnv": "O establece la variable de entorno AX_CODE_BINARY.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de AX Code Desktop para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor AX Code Desktop o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando AX Code Desktop. Verifica que la dirección apunte a un servidor AX Code Desktop.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "AX Code Local no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "La CLI de AX Code no pudo iniciarse o no está instalado. Instala AX Code o conecta a un servidor remoto en su lugar.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando AX Code Desktop. Verifica que la dirección apunte a un servidor AX Code Desktop.",
  ...
  "startup.initRecovery.description": "AX Code Desktop no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando AX Code Desktop...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: ax-code-desktop update",
  "axCodeUpdate.toast.available.title": "Actualización de AX Code",
  "axCodeUpdate.toast.available.description": "Versión {version} disponible.",
  "axCodeUpdate.toast.actions.update": "Actualizar",
  "axCodeUpdate.toast.actions.dismiss": "Descartar",
  "axCodeUpdate.toast.actions.reload": "Recargar AX Code",
  "axCodeUpdate.toast.upgrading.title": "Actualizando AX Code...",
  "axCodeUpdate.toast.upgrading.description": "Mantén AX Code Desktop abierto.",
  "axCodeUpdate.toast.updated.title": "AX Code actualizado",
  "axCodeUpdate.toast.updated.description": "Actualización instalada.",
  "axCodeUpdate.toast.updated.descriptionWithVersion": "Versión {version} instalada.",
  "axCodeUpdate.toast.failed.title": "No se pudo actualizar AX Code",
  "axCodeUpdate.toast.failed.description": "La actualización de AX Code falló.",
  "axCodeUpdate.toast.reload.message": "Reiniciando AX Code...",
  ...
  "memoryDebugPanel.streaming.copy.hint": "Copia las métricas de streaming de la UI como JSON",
  ...
  "openChamberLogo.aria.logo": "Logo de AX Code Desktop",
  ...
  'chat.scrollToBottom.newMessages': '{count} new',
  'chat.emptyState.tagline': 'Your AI coding workspace',
  'chat.draftStarters.pinHint': 'Pin shortcuts here',
  'chat.message.sentAt': 'Sent {time}',
};
