...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 AX Code App',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 AX Code App 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'header.services.shutdownDev': '停止 AX Code App',
  ...
  'aboutDialog.openChamberVersionLabel': 'AX Code App 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 AX Code App 状态、AX Code 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 AX Code App',
  ...
  'header.actions.openAppMenu': 'AX Code App 菜单',
  'header.actions.openAppMenuAria': '打开 AX Code App 菜单',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 AX Code App',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 AX Code App 服务器之间切换',
  ...
  'multiRun.window.description': 'AX Code App 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 AX Code App',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 AX Code App 未自动检测到 AX Code，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'AX Code 是 AX Code App 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 AX Code App 设置并重新加载 AX Code 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 AX Code App 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 AX Code App 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 AX Code App。请确认地址是否指向 AX Code App 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 AX Code App。请确认地址是否指向 AX Code App 服务器。',
  ...
  'startup.initRecovery.description': 'AX Code App 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.updating': '正在更新 AX Code App...',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：ax-code-app update',
  ...
  'axCodeUpdate.toast.upgrading.description': '请保持 AX Code App 打开。',
  ...
  'openChamberLogo.aria.logo': 'AX Code App 标志',
