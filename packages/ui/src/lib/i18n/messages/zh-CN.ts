...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 AX Code Desktop',
  ...
  'gitView.sync.commitOrStashTooltip': 'Pull 前请先提交或储藏你的更改',
  'gitView.sync.moreActionsAria': '更多同步操作',
  'gitView.sync.noRemoteTooltip': '未配置远程',
  'gitView.sync.pull': 'Pull',
  'gitView.sync.pullChanges': 'Pull 更改',
  'gitView.sync.pullChangesTooltip': 'Pull {behind} 个',
  'gitView.sync.push': 'Push',
  'gitView.sync.pushChanges': 'Push 更改',
  'gitView.sync.pushChangesTooltip': 'Push {ahead} 个',
  ...
  'gitView.toast.commitOrStashBeforeSync': 'Pull 前请先提交或储藏你的更改',
  'gitView.toast.alreadyUpToDate': '已是最新状态',
  'gitView.toast.pullBeforePush': 'Push 前请先从 {name} Pull（落后 {count} 个）',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 AX Code Desktop 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 AX Code Desktop 状态、AX Code 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 AX Code Desktop',
  ...
  'header.actions.openAppMenu': 'AX Code Desktop 菜单',
  'header.actions.openAppMenuAria': '打开 AX Code Desktop 菜单',
  ...
  'chat.emptyState.axCodeUnreachable': '无法连接 AX Code',
  ...
  'chat.draftPresets.summarise.label': '摘要代码库',
  'chat.draftPresets.findBugs.label': '查找最近提交中的错误',
  'chat.draftPresets.writeTests.label': '为最近更改编写测试',
  'chat.projectKnowledge.loaded': 'CLAUDE.md 已加载',
  'chat.projectKnowledge.create': '创建 CLAUDE.md',
  ...
  'chat.chatInput.executionMode.title': '执行模式',
  'chat.chatInput.executionMode.manual': '手动',
  'chat.chatInput.executionMode.autonomous': '自主',
  'chat.chatInput.executionMode.longRun': '长时运行',
  'chat.chatInput.executionMode.manualHint': '由你批准有风险的步骤',
  'chat.chatInput.executionMode.autonomousHint': '自动批准安全工具，继续多步执行',
  'chat.chatInput.executionMode.longRunHint': '自主模式，最长 72 小时并限速',
  'chat.chatInput.executionMode.updateFailed': '无法更新执行模式',
  ...
  'axCodeStatusDialog.title': 'AX Code 状态',
  'axCodeStatusDialog.description': '查看当前 AX Code 状态与诊断信息。',
  'axCodeStatusDialog.actions.copy': '复制',
  'axCodeStatusDialog.empty.noData': '无数据。',
  'axCodeStatusDialog.toast.copiedTitle': '已复制',
  'axCodeStatusDialog.toast.copiedDescription': '状态已复制到剪贴板',
  'axCodeStatusDialog.toast.copyFailed': '复制状态失败',
  ...
  'mcpDropdown.empty.configureInConfig': '请在 AX Code 配置中设置 MCP 服务器。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 AX Code Desktop',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 AX Code Desktop 服务器之间切换',
  ...
  'multiRun.window.description': 'AX Code Desktop 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 AX Code Desktop',
  ...
  'onboarding.localSetup.title': '设置 AX Code',
  'onboarding.localSetup.description': '安装 AX Code CLI 以继续。',
  'onboarding.localSetup.dialog.selectAxCodeBinary': '选择 AX Code 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'AX Code CLI 尚未就绪。请确认安装完成后重试。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 AX Code Desktop 未自动检测到 AX Code，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'AX Code 是 AX Code Desktop 的核心，先安装它即可开始。',
  'onboarding.localSetup.docs.windows': 'AX Code Windows + WSL 文档',
  'onboarding.localSetup.docs.default': 'AX Code 文档',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 AX Code CLI 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待 AX Code',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 AX Code CLI 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 AX Code Desktop 设置并重新加载 AX Code 配置。',
  'onboarding.localSetup.remotePreference': '更希望使用远程服务器？',
  'onboarding.localSetup.actions.connectRemoteServer': '连接远程服务器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，建议在 WSL 中安装并运行 AX Code 以获得最佳兼容性。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若检测失败，请设置本地路径（ax-code.cmd/ax-code.exe）、wsl.exe，或 wsl:/usr/local/bin/ax-code。',
  'onboarding.localSetup.hint.ensurePath': '已安装？请确认 ax-code 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或设置 AX_CODE_BINARY 环境变量。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 AX Code Desktop 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 AX Code Desktop 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 AX Code Desktop。请确认地址是否指向 AX Code Desktop 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 AX Code 不可用',
  'onboarding.desktopRecovery.localUnavailable.description': 'AX Code CLI 无法启动或未安装。请安装 AX Code，或改为连接远程服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 AX Code Desktop。请确认地址是否指向 AX Code Desktop 服务器。',
  ...
  'startup.initRecovery.description': 'AX Code Desktop 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：ax-code-desktop update',
  'axCodeUpdate.toast.available.title': 'AX Code 更新',
  'axCodeUpdate.toast.available.description': '版本 {version} 可用。',
  'axCodeUpdate.toast.actions.update': '更新',
  'axCodeUpdate.toast.actions.dismiss': '忽略',
  'axCodeUpdate.toast.actions.reload': '重载 AX Code',
  'axCodeUpdate.toast.upgrading.title': '正在更新 AX Code...',
  'axCodeUpdate.toast.upgrading.description': '请保持 AX Code Desktop 打开。',
  'axCodeUpdate.toast.updated.title': 'AX Code 已更新',
  'axCodeUpdate.toast.updated.description': '更新已安装。',
  'axCodeUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安装。',
  'axCodeUpdate.toast.failed.title': '无法更新 AX Code',
  'axCodeUpdate.toast.failed.description': 'AX Code 升级失败。',
  'axCodeUpdate.toast.reload.message': '正在重启 AX Code...',
  ...
  'memoryDebugPanel.streaming.copy.hint': '复制会导出 UI 流式指标 JSON',
  ...
  'openChamberLogo.aria.logo': 'AX Code Desktop 标志',
