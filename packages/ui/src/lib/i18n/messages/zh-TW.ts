...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 AX Code Desktop',
  ...
  'gitView.sync.commitOrStashTooltip': 'Pull 前請先提交或 Stash 你的變更',
  'gitView.sync.moreActionsAria': '更多同步操作',
  'gitView.sync.noRemoteTooltip': '未設定遠端',
  'gitView.sync.pull': 'Pull',
  'gitView.sync.pullChanges': 'Pull 變更',
  'gitView.sync.pullChangesTooltip': 'Pull {behind} 筆',
  'gitView.sync.push': 'Push',
  'gitView.sync.pushChanges': 'Push 變更',
  'gitView.sync.pushChangesTooltip': 'Push {ahead} 筆',
  ...
  'gitView.toast.commitOrStashBeforeSync': 'Pull 前請先提交或 Stash 你的變更',
  'gitView.toast.alreadyUpToDate': '已是最新狀態',
  'gitView.toast.pullBeforePush': 'Push 前請先從 {name} Pull（落後 {count} 筆）',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 AX Code Desktop 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'header.services.shutdownDev': '停止 AX Code Desktop',
  ...
  'aboutDialog.openChamberVersionLabel': 'AX Code Desktop 版本 {version}',
  'aboutDialog.axCodeVersionLabel': 'AX Code 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 AX Code Desktop 狀態、AX Code 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 AX Code Desktop',
  ...
  'header.actions.openAppMenu': 'AX Code Desktop 選單',
  'header.actions.openAppMenuAria': '開啟 AX Code Desktop 選單',
  ...
  'chat.emptyState.axCodeUnreachable': '無法連線 AX Code',
  ...
  'chat.draftPresets.summarise.label': '摘要程式庫',
  'chat.draftPresets.findBugs.label': '尋找最近提交中的錯誤',
  'chat.draftPresets.writeTests.label': '為最近變更撰寫測試',
  'chat.projectKnowledge.loaded': 'CLAUDE.md 已載入',
  'chat.projectKnowledge.create': '建立 CLAUDE.md',
  ...
  'chat.chatInput.executionMode.title': '執行模式',
  'chat.chatInput.executionMode.manual': '手動',
  'chat.chatInput.executionMode.autonomous': '自主',
  'chat.chatInput.executionMode.longRun': '長時執行',
  'chat.chatInput.executionMode.manualHint': '由你核准有風險的步驟',
  'chat.chatInput.executionMode.autonomousHint': '自動核准安全工具，繼續多步執行',
  'chat.chatInput.executionMode.longRunHint': '自主模式，最長 72 小時並限速',
  'chat.chatInput.executionMode.updateFailed': '無法更新執行模式',
  ...
  'axCodeStatusDialog.title': 'AX Code 狀態',
  'axCodeStatusDialog.description': '查看目前 AX Code 狀態與診斷資訊。',
  'axCodeStatusDialog.actions.copy': '複製',
  'axCodeStatusDialog.empty.noData': '無資料。',
  'axCodeStatusDialog.toast.copiedTitle': '已複製',
  'axCodeStatusDialog.toast.copiedDescription': '狀態已複製到剪貼簿',
  'axCodeStatusDialog.toast.copyFailed': '複製狀態失敗',
  ...
  'mcpDropdown.empty.configureInConfig': '請在 AX Code 設定中設定 MCP 伺服器。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 AX Code Desktop',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 AX Code Desktop 伺服器之間切換',
  ...
  'multiRun.window.description': 'AX Code Desktop 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 AX Code Desktop',
  ...
  'onboarding.localSetup.title': '設定 AX Code',
  'onboarding.localSetup.description': '安裝 AX Code CLI 以繼續。',
  'onboarding.localSetup.dialog.selectAxCodeBinary': '選擇 AX Code 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'AX Code CLI 尚未就緒。請確認安裝完成後重試。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 AX Code Desktop 未自動偵測到 AX Code，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'AX Code 是 AX Code Desktop 的核心，先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'AX Code Windows + WSL 文件',
  'onboarding.localSetup.docs.default': 'AX Code 文件',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 AX Code CLI 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待 AX Code',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 AX Code CLI 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 AX Code Desktop 設定並重新載入 AX Code 設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，建議在 WSL 中安裝並執行 AX Code 以獲得最佳相容性。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若偵測失敗，請設定本地路徑（ax-code.cmd/ax-code.exe）、wsl.exe，或 wsl:/usr/local/bin/ax-code。',
  'onboarding.localSetup.hint.ensurePath': '已安裝？請確認 ax-code 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或設定 AX_CODE_BINARY 環境變數。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 AX Code Desktop 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 AX Code Desktop 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 AX Code Desktop。請確認位址是否指向 AX Code Desktop 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 AX Code 無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': 'AX Code CLI 無法啟動或未安裝。請安裝 AX Code，或改為連接遠端伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 AX Code Desktop。請確認位址是否指向 AX Code Desktop 伺服器。',
  ...
  'startup.initRecovery.description': 'AX Code Desktop 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 AX Code Desktop...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：ax-code-desktop update',
  'axCodeUpdate.toast.available.title': 'AX Code 更新',
  'axCodeUpdate.toast.available.description': '版本 {version} 可安裝。',
  'axCodeUpdate.toast.actions.update': '更新',
  'axCodeUpdate.toast.actions.dismiss': '忽略',
  'axCodeUpdate.toast.actions.reload': '重新載入 AX Code',
  'axCodeUpdate.toast.upgrading.title': '正在更新 AX Code...',
  'axCodeUpdate.toast.upgrading.description': '請保持 AX Code Desktop 開啟。',
  'axCodeUpdate.toast.updated.title': 'AX Code 已更新',
  'axCodeUpdate.toast.updated.description': '更新已安裝。',
  'axCodeUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安裝。',
  'axCodeUpdate.toast.failed.title': '無法更新 AX Code',
  'axCodeUpdate.toast.failed.description': 'AX Code 升級失敗。',
  'axCodeUpdate.toast.reload.message': '正在重新啟動 AX Code...',
  ...
  'memoryDebugPanel.streaming.copy.hint': '複製會匯出 UI 串流指標 JSON',
  ...
  'openChamberLogo.aria.logo': 'AX Code Desktop 標誌',
