...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 AX Code App',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 AX Code App 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 AX Code App 狀態、AX Code 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 AX Code App',
  ...
  'header.actions.openAppMenu': 'AX Code App 選單',
  'header.actions.openAppMenuAria': '開啟 AX Code App 選單',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 AX Code App',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 AX Code App 伺服器之間切換',
  ...
  'multiRun.window.description': 'AX Code App 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 AX Code App',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 AX Code App 未自動偵測到 AX Code，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'AX Code 是 AX Code App 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 AX Code App 設定並重新載入 AX Code 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 AX Code App 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 AX Code App 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 AX Code App。請確認位址是否指向 AX Code App 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 AX Code App。請確認位址是否指向 AX Code App 伺服器。',
  ...
  'startup.initRecovery.description': 'AX Code App 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：ax-code-app update',
  ...
  'axCodeUpdate.toast.upgrading.description': '請保持 AX Code App 開啟。',
