export const settingsDict = {
  ...
  'settings.window.description': 'AX Code App settings window.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Managed installs/updates and starts AX Code App remotely. External assumes it is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port AX Code App should use on the remote host. Leave empty to let the runtime choose.',
  'settings.remoteInstances.page.field.keepServerRunning': 'Keep server running',
  'settings.remoteInstances.page.field.keepServerRunningHint': 'If enabled, AX Code App daemon is left running remotely when you disconnect.',
  ...
  'settings.remoteInstances.page.field.preferredLocalPortHint': 'Preferred local port for the main AX Code App tunnel. Leave empty for auto-select.',
  ...
  'settings.openchamber.about.title': 'About AX Code App',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. AX Code App will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start AX Code App at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start AX Code App when you log in',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'AX Code App asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.remoteInstances.page.section.remoteServerDescription': 'How AX Code App is managed and started on the remote host.',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote AX Code App UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How AX Code App is installed when running in managed mode.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing AX Code App',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating AX Code App',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to AX Code and never stored by AX Code App.',
  ...
  'settings.github.page.flow.title': 'Authorize AX Code App',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from AX Code App.',
  ...
  'settings.voice.page.tooltip.browser': 'Free, offline, desktop browser voice.',
  'settings.voice.page.tooltip.openai': 'High quality, desktop voice, needs API key.',
