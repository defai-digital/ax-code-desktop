export const settingsDict = {
  ...
  'settings.view.actions.reloadAxCode': 'Reload AX Code',
  'settings.view.actions.reloadAxCodeTooltip': 'Restart AX Code and reload its configuration.',
  ...
  'settings.snippets.page.hint': 'Use #name in prompts. Supports aliases and prepend/append blocks compatible with ax-code-snippets.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Managed installs/updates and starts AX Code Desktop remotely. External assumes it is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port AX Code Desktop should use on the remote host. Leave empty to let the runtime choose.',
  'settings.remoteInstances.page.field.keepServerRunning': 'Keep server running',
  'settings.remoteInstances.page.field.keepServerRunningHint': 'If enabled, AX Code Desktop daemon is left running remotely when you disconnect.',
  ...
  'settings.remoteInstances.page.field.preferredLocalPortHint': 'Preferred local port for the main AX Code Desktop tunnel. Leave empty for auto-select.',
  ...
  'settings.openchamber.about.title': 'About AX Code Desktop',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update {path}. AX Code also includes any project-level AGENTS.md rules when they exist.',
  ...
  'settings.skills.location.option.userAxCode.label': 'User / AX Code',
  'settings.skills.location.option.userAxCode.description': 'Global AX Code config location',
  'settings.skills.location.option.projectAxCode.label': 'Project / AX Code',
  'settings.skills.location.option.projectAxCode.description': 'Current project .ax-code location',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. AX Code Desktop will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start AX Code Desktop at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start AX Code Desktop when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so trusted computers on your Wi-Fi can open it.',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'AX Code Desktop asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.openchamber.axCodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.openchamber.axCodeCli.tooltipSuffix': 'binary.',
  'settings.openchamber.axCodeCli.field.binaryPath': 'AX Code Binary Path',
  'settings.openchamber.axCodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/ax-code',
  'settings.openchamber.axCodeCli.field.showUpdateNotifications': 'Show AX Code update notifications',
  'settings.openchamber.axCodeCli.field.showUpdateNotificationsAria': 'Show AX Code update notifications',
  'settings.openchamber.axCodeCli.actions.browseAria': 'Browse for AX Code binary path',
  'settings.openchamber.axCodeCli.actions.browse': 'Browse',
  'settings.openchamber.axCodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.openchamber.axCodeCli.actions.restartingAxCode': 'Restarting AX Code…',
  'settings.openchamber.axCodeCli.dialog.selectBinaryTitle': 'Select ax-code binary',
  'settings.openchamber.axCodeCli.tipPrefix': 'Tip: you can also use',
  'settings.openchamber.axCodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.remoteInstances.page.section.remoteServerDescription': 'How AX Code Desktop is managed and started on the remote host.',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote AX Code Desktop UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How AX Code Desktop is installed when running in managed mode.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing AX Code Desktop',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating AX Code Desktop',
  ...
  'settings.openchamber.worktrees.list.tooltip': 'Worktrees live outside the repo (AX Code-managed). Deleting a worktree also removes linked sessions.',
  ...
  'settings.providers.sidebar.empty.description': 'Check your AX Code configuration',
  'settings.providers.sidebar.loading.title': 'Loading providers...',
  'settings.providers.sidebar.error.title': 'Unable to load providers',
  'settings.providers.sidebar.error.description': 'AX Code may still be starting. Retry once it is ready.',
  'settings.providers.sidebar.error.retry': 'Retry',
  'settings.providers.sidebar.error.retrying': 'Retrying...',
  ...
  'settings.providers.page.empty.checkAxCodeConfiguration': 'Check your AX Code configuration',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to AX Code and never stored by AX Code Desktop.',
  ...
  'settings.providers.page.toast.apiKeySavedRestartFailed': 'API key saved, but AX Code did not restart',
  ...
  'settings.providers.page.toast.oauthCompletedRestartFailed': 'OAuth completed, but AX Code did not restart',
  ...
  'settings.mcp.page.status.description.connected': 'Connected and ready for AX Code to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'AX Code could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForAxCode': 'Waiting for AX Code to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Leave blank to use AX Code\'s default MCP timeout.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let AX Code infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.env.plainTextWarning': '⚠ Values are stored as plain text in ax-code.json',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'AX Code will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but AX Code reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but AX Code reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. AX Code reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. AX Code reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but AX Code reload failed',
  ...
  'settings.mcp.page.toast.axCodeReloadFailedAfterCallbackSave': 'AX Code reload failed after saving the browser callback URL',
  ...
  'settings.openchamber.defaults.summaryAxCodeDefault': 'AX Code agent default',
  ...
  'settings.github.page.flow.title': 'Authorize AX Code Desktop',
  ...
  'settings.notifications.page.summary.modelTooltip': 'Used for notification summaries.',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from AX Code Desktop.',
  ...
  'settings.openchamber.visual.field.showTurnChangedFilesAria': 'Show changed files on completed turns',
  'settings.openchamber.visual.field.showTurnChangedFiles': 'Show Changed Files on Turns',
