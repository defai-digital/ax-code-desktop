...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o AX Code Desktop",
  ...
  "gitView.sync.commitOrStashTooltip": "Faça commit ou stash das alterações antes de fazer pull",
  ...
  "gitView.toast.commitOrStashBeforeSync": "Faça commit ou stash das alterações antes de fazer pull",
  "gitView.toast.alreadyUpToDate": "Já está atualizado",
  "gitView.toast.pullBeforePush": "Faça pull de {name} antes de fazer push ({count} atrás)",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao AX Code Desktop — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "header.services.shutdownDev": "Parar AX Code Desktop",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do AX Code Desktop {version}",
  "aboutDialog.axCodeVersionLabel": "Versão do AX Code {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do AX Code Desktop, a integridade do AX Code, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo AX Code Desktop com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do AX Code Desktop",
  "header.actions.openAppMenuAria": "Abrir menu do AX Code Desktop",
  ...
  "chat.emptyState.axCodeUnreachable": "AX Code não está acessível",
  ...
  "chat.draftPresets.summarise.label": "Resumir o código",
  "chat.draftPresets.findBugs.label": "Encontrar bugs nos commits recentes",
  "chat.draftPresets.writeTests.label": "Escrever testes para mudanças recentes",
  "chat.projectKnowledge.loaded": "CLAUDE.md carregado",
  "chat.projectKnowledge.create": "Criar CLAUDE.md",
  ...
  "chat.activity.aria": "Atividade do agente: {label}",
  ...
  "chat.chatInput.executionMode.title": "Modo de execução",
  "chat.chatInput.executionMode.manual": "Manual",
  "chat.chatInput.executionMode.autonomous": "Autônomo",
  "chat.chatInput.executionMode.longRun": "Longa duração",
  "chat.chatInput.executionMode.manualHint": "Você aprova as etapas arriscadas",
  "chat.chatInput.executionMode.autonomousHint": "Aprova automaticamente ferramentas seguras; continua execuções de várias etapas",
  "chat.chatInput.executionMode.longRunHint": "Autônomo, até 72h com ritmo controlado",
  "chat.chatInput.executionMode.updateFailed": "Não foi possível atualizar o modo de execução",
  ...
  "axCodeStatusDialog.title": "Status do AX Code",
  "axCodeStatusDialog.description": "Inspecione o status atual do AX Code e os diagnósticos.",
  "axCodeStatusDialog.actions.copy": "Copiar",
  "axCodeStatusDialog.empty.noData": "Não há dados.",
  "axCodeStatusDialog.toast.copiedTitle": "Copiado",
  "axCodeStatusDialog.toast.copiedDescription": "Status copiado para a área de transferência",
  "axCodeStatusDialog.toast.copyFailed": "Não foi possível copiar o status",
  ...
  "mcpDropdown.empty.configureInConfig": "Configure os servidores MCP na configurações do AX Code.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do AX Code Desktop",
  ...
  "multiRun.window.description": "Janela do AX Code Desktop Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao AX Code Desktop",
  ...
  "onboarding.localSetup.title": "Configuração do AX Code",
  "onboarding.localSetup.description": "Instale a CLI do AX Code para continuar.",
  "onboarding.localSetup.dialog.selectAxCodeBinary": "Selecionar executável de ax-code",
  "onboarding.localSetup.errors.cliNotReady": "A CLI do AX Code ainda não está pronta. Confirme que a instalação está completa e tente novamente.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o AX Code Desktop não detectar o AX Code automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "AX Code é o coração do AX Code Desktop. Instale-o para começar.",
  "onboarding.localSetup.docs.windows": "Documentação do AX Code para Windows + WSL",
  "onboarding.localSetup.docs.default": "Documentação do AX Code",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Clique para verificar se a CLI do AX Code está disponível. Se a verificação funcionar, você entrará automaticamente na tela principal.",
  "onboarding.localSetup.status.watching": "Aguardando AX Code",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automaticamente assim que detectado.",
  "onboarding.localSetup.field.alreadyInstalled": "Já está instalado? Defina o caminho da CLI do AX Code:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do AX Code Desktop e recarregue configurações do AX Code.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "No Windows, instale e execute AX Code no WSL para maior compatibilidade.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Se a detecção falhar, defina um caminho nativo (ax-code.cmd/ax-code.exe), wsl.exe ou wsl:/usr/local/bin/ax-code.",
  "onboarding.localSetup.hint.ensurePath": "Já está instalado? Confira se ax-code está no seu PATH.",
  "onboarding.localSetup.hint.setEnv": "Ou defina a variável de ambiente AX_CODE_BINARY.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do AX Code Desktop para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor AX Code Desktop ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando AX Code Desktop. Verifique se o endereço aponta para um servidor AX Code Desktop.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "AX Code Local não disponível",
  "onboarding.desktopRecovery.localUnavailable.description": "A CLI do AX Code não pôde ser iniciada ou não está instalada. Instale o AX Code ou conecte um servidor remoto no lugar dela.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando AX Code Desktop. Verifique se o endereço aponta para um servidor AX Code Desktop.",
  ...
  "startup.initRecovery.description": "O AX Code Desktop não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando AX Code Desktop...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: ax-code-desktop update",
  "axCodeUpdate.toast.available.title": "Atualização do AX Code",
  "axCodeUpdate.toast.available.description": "Versão {version} disponível.",
  "axCodeUpdate.toast.actions.update": "Atualizar",
  "axCodeUpdate.toast.actions.dismiss": "Dispensar",
  "axCodeUpdate.toast.actions.reload": "Recarregar AX Code",
  "axCodeUpdate.toast.upgrading.title": "Atualizando AX Code...",
  "axCodeUpdate.toast.upgrading.description": "Mantenha o AX Code Desktop aberto.",
  "axCodeUpdate.toast.updated.title": "AX Code atualizado",
  "axCodeUpdate.toast.updated.description": "Atualização instalada.",
  "axCodeUpdate.toast.updated.descriptionWithVersion": "Versão {version} instalada.",
  "axCodeUpdate.toast.failed.title": "Não foi possível atualizar o AX Code",
  "axCodeUpdate.toast.failed.description": "A atualização do AX Code falhou.",
  ...
  "memoryDebugPanel.streaming.copy.hint": "Copia métricas de streaming da UI como JSON",
  ...
  "openChamberLogo.aria.logo": "Logo do AX Code Desktop",
