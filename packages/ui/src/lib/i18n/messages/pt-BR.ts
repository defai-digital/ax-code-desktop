...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o AX Code App",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao AX Code App — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "header.services.shutdownDev": "Parar AX Code App",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do AX Code App {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do AX Code App, a integridade do AX Code, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo AX Code App com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do AX Code App",
  "header.actions.openAppMenuAria": "Abrir menu do AX Code App",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear AX Code App",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do AX Code App",
  ...
  "multiRun.window.description": "Janela do AX Code App Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao AX Code App",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o AX Code App não detectar o AX Code automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "AX Code é o coração do AX Code App. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do AX Code App e recarregue configurações do AX Code.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do AX Code App para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor AX Code App ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando AX Code App. Verifique se o endereço aponta para um servidor AX Code App.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando AX Code App. Verifique se o endereço aponta para um servidor AX Code App.",
  ...
  "startup.initRecovery.description": "O AX Code App não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando AX Code App...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: ax-code-app update",
  ...
  "axCodeUpdate.toast.upgrading.description": "Mantenha o AX Code App aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do AX Code App",
