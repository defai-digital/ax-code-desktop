...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Про AX Code App",
  ...
  "contextPanel.browser.trustNotice": "Сторінки, відкриті тут, працюють із повним доступом до AX Code App — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.",
  ...
  "header.services.shutdownDev": "Зупинити AX Code App",
  ...
  "aboutDialog.openChamberVersionLabel": "Версія AX Code App {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан AX Code App, стан AX Code, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації AX Code App",
  ...
  "header.actions.openAppMenu": "Меню AX Code App",
  "header.actions.openAppMenuAria": "Відкрити меню AX Code App",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати AX Code App",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими AX Code App серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску AX Code App.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до AX Code App",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо AX Code App не визначає AX Code автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "AX Code — серце AX Code App. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в AX Code App і перезавантажує конфігурацію AX Code.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера AX Code App для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер AX Code App або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює AX Code App. Перевірте, чи адреса вказує на сервер AX Code App.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено AX Code App. Перевірте, чи адреса вказує на сервер AX Code App.",
  ...
  "startup.initRecovery.description": "AX Code App не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення AX Code App...",
  ...
  "updateDialog.error.takingLonger": "Оновлення триває довше, ніж очікувалося. Зачекайте трохи та оновіть або запустіть: ax-code-app update",
  ...
  "axCodeUpdate.toast.upgrading.description": "Залиште AX Code App відкритим.",
