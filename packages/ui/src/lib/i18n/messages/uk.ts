...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Про AX Code Desktop",
  ...
  "gitView.sync.commitOrStashTooltip": "Закомітьте або сховайте зміни перед pull",
  ...
  "gitView.toast.commitOrStashBeforeSync": "Закомітьте або сховайте зміни перед pull",
  "gitView.toast.alreadyUpToDate": "Вже актуально",
  "gitView.toast.pullBeforePush": "Спочатку зробіть pull з {name} ({count} позаду)",
  ...
  "contextPanel.browser.trustNotice": "Сторінки, відкриті тут, працюють із повним доступом до AX Code Desktop — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.",
  ...
  "header.services.shutdownDev": "Зупинити AX Code Desktop",
  ...
  "aboutDialog.openChamberVersionLabel": "Версія AX Code Desktop {version}",
  "aboutDialog.axCodeVersionLabel": "Версія AX Code {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан AX Code Desktop, стан AX Code, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації AX Code Desktop",
  ...
  "header.actions.openAppMenu": "Меню AX Code Desktop",
  "header.actions.openAppMenuAria": "Відкрити меню AX Code Desktop",
  ...
  "chat.emptyState.axCodeUnreachable": "AX Code недоступний",
  ...
  "chat.draftPresets.summarise.label": "Підсумувати кодову базу",
  "chat.draftPresets.findBugs.label": "Знайти помилки в останніх комітах",
  "chat.draftPresets.writeTests.label": "Написати тести для останніх змін",
  "chat.projectKnowledge.loaded": "CLAUDE.md завантажено",
  "chat.projectKnowledge.create": "Створити CLAUDE.md",
  ...
  "chat.activity.aria": "Активність агента: {label}",
  ...
  "chat.chatInput.executionMode.title": "Режим виконання",
  "chat.chatInput.executionMode.manual": "Ручний",
  "chat.chatInput.executionMode.autonomous": "Автономний",
  "chat.chatInput.executionMode.longRun": "Тривалий",
  "chat.chatInput.executionMode.manualHint": "Ви схвалюєте ризиковані кроки",
  "chat.chatInput.executionMode.autonomousHint": "Автоматично схвалює безпечні інструменти; продовжує багатокрокові запуски",
  "chat.chatInput.executionMode.longRunHint": "Автономний, до 72 год із регулюванням темпу",
  "chat.chatInput.executionMode.updateFailed": "Не вдалося оновити режим виконання",
  ...
  "axCodeStatusDialog.title": "Статус AX Code",
  "axCodeStatusDialog.description": "Перегляньте поточний стан AX Code і діагностику.",
  "axCodeStatusDialog.actions.copy": "Копіювати",
  "axCodeStatusDialog.empty.noData": "Немає даних.",
  "axCodeStatusDialog.toast.copiedTitle": "Скопійовано",
  "axCodeStatusDialog.toast.copiedDescription": "Статус скопійовано в буфер обміну",
  "axCodeStatusDialog.toast.copyFailed": "Не вдалося скопіювати статус",
  ...
  "mcpDropdown.empty.configureInConfig": "Налаштувати сервери MCP у конфігурації AX Code.",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати AX Code Desktop",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими AX Code Desktop серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску AX Code Desktop.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до AX Code Desktop",
  ...
  "onboarding.localSetup.title": "Налаштування AX Code",
  "onboarding.localSetup.description": "Установіть AX Code CLI, щоб продовжити.",
  "onboarding.localSetup.dialog.selectAxCodeBinary": "Вибрати виконуваний файл ax-code",
  "onboarding.localSetup.errors.cliNotReady": "AX Code CLI ще не готовий. Підтвердьте, що встановлення завершено, і повторіть спробу.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо AX Code Desktop не визначає AX Code автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "AX Code — серце AX Code Desktop. Встановіть його, щоб почати.",
  "onboarding.localSetup.docs.windows": "Документація AX Code для Windows + WSL",
  "onboarding.localSetup.docs.default": "Документація AX Code",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Натисніть, щоб перевірити, чи доступний AX Code CLI. У разі успіху ви автоматично перейдете на головний екран.",
  "onboarding.localSetup.status.watching": "Очікування AX Code",
  "onboarding.localSetup.status.autoContinue": "Ми автоматично продовжимо після виявлення.",
  "onboarding.localSetup.field.alreadyInstalled": "Вже встановлено? Встановіть шлях AX Code CLI:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в AX Code Desktop і перезавантажує конфігурацію AX Code.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "У Windows інсталюйте та запустіть AX Code у WSL для найкращої сумісності.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Якщо виявлення з помилкою, установіть власний шлях (ax-code.cmd/ax-code.exe), wsl.exe або wsl:/usr/local/bin/ax-code.",
  "onboarding.localSetup.hint.ensurePath": "Вже встановлено? Переконайтеся, що ax-code знаходиться у вашому PATH.",
  "onboarding.localSetup.hint.setEnv": "Або встановіть змінну середовища AX_CODE_BINARY.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера AX Code Desktop для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер AX Code Desktop або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює AX Code Desktop. Перевірте, чи адреса вказує на сервер AX Code Desktop.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "AX Code Local недоступний",
  "onboarding.desktopRecovery.localUnavailable.description": "AX Code CLI не вдалося запустити або не встановлено. Встановіть AX Code або підключіться до віддаленого сервера.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено AX Code Desktop. Перевірте, чи адреса вказує на сервер AX Code Desktop.",
  ...
  "startup.initRecovery.description": "AX Code Desktop не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення AX Code Desktop...",
  ...
  "updateDialog.error.takingLonger": "Оновлення триває довше, ніж очікувалося. Зачекайте трохи та оновіть або запустіть: ax-code-desktop update",
  "axCodeUpdate.toast.available.title": "Оновлення AX Code",
  "axCodeUpdate.toast.available.description": "Версія {version} доступна.",
  "axCodeUpdate.toast.actions.update": "Оновити",
  "axCodeUpdate.toast.actions.dismiss": "Сховати",
  "axCodeUpdate.toast.actions.reload": "Перезавантажити AX Code",
  "axCodeUpdate.toast.upgrading.title": "Оновлення AX Code...",
  "axCodeUpdate.toast.upgrading.description": "Залиште AX Code Desktop відкритим.",
  "axCodeUpdate.toast.updated.title": "AX Code оновлено",
  "axCodeUpdate.toast.updated.description": "Оновлення встановлено.",
  "axCodeUpdate.toast.updated.descriptionWithVersion": "Версію {version} встановлено.",
  "axCodeUpdate.toast.failed.title": "Не вдалося оновити AX Code",
  "axCodeUpdate.toast.failed.description": "Оновлення AX Code не вдалося.",
  "axCodeUpdate.toast.reload.message": "Перезапуск AX Code...",
  ...
  "memoryDebugPanel.streaming.copy.hint": "Копіює метрики потокового інтерфейсу користувача як JSON",
  ...
  "openChamberLogo.aria.logo": "Логотип AX Code Desktop",
