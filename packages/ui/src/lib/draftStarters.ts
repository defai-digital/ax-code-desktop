...
export const BUILTIN_STARTERS: readonly BuiltInStarter[] = [
    ...
    { name: 'summarise', icon: 'code-ai', labelKey: 'chat.draftPresets.summarise.label', command: 'Summarise this codebase and explain the main architecture' },
    { name: 'find-bugs', icon: 'git-commit', labelKey: 'chat.draftPresets.findBugs.label', command: 'Find bugs or issues in the recent git commits' },
    { name: 'write-tests', icon: 'file-check', labelKey: 'chat.draftPresets.writeTests.label', command: 'Write tests for the recently changed files' },
];
