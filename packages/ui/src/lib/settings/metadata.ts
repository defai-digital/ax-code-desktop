...
export const SETTINGS_PAGE_METADATA: readonly SettingsPageMeta[] = [
  ...
  },
  {
    ...
    group: 'ax-code',
    kind: 'split',
    keywords: ['plugin', 'plugins', 'extensions', 'addons', 'npm', 'ax-code-wakatime'],
  },
  {
  ...
  },
  {
    ...
    group: 'appearance',
    kind: 'single',
    keywords: ['theme', 'font', 'spacing', 'padding', 'corner radius', 'radius', 'input bar', 'keyboard', 'viewport', 'terminal', 'install name', 'app shortcuts'],
  },
  {
    slug: 'chat',
    title: 'Chat',
  ...
  { slug: 'voice', title: 'Voice', group: 'advanced', kind: 'single', keywords: ['tts', 'speech', 'voice'] },
  { slug: 'tunnel', title: 'Remote Tunnel', group: 'advanced', kind: 'single', keywords: ['tunnel', 'cloudflare', 'remote', 'share'] },
] as const;
