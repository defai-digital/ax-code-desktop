...
interface UseInlineCommentControllerOptions<TRange extends LineRange> {
...
export const normalizeLineRange = <TRange extends LineRange>(range: TRange): TRange => {
...
export function useInlineCommentController<TRange extends LineRange>(
