...
import { toMultiRunFileAttachment, type CreateMultiRunParams, type MultiRunGroup, type MultiRunLocalFileAttachment } from '@/types/multirun';
...
export const MultiRunLauncher: React.FC<MultiRunLauncherProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const filesForStore = attachedFiles.map(toMultiRunFileAttachment);
