  ...
  switch (variant) {
    case 'local-unavailable':
      return {
        ...
        description: 'AX Code CLI could not be started or is not installed. Install AX Code or connect to a remote server instead.',
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running AX Code App. Verify the address points to an AX Code App server.`,
