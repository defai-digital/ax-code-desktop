...
export const SIDEBAR_SECTIONS: SidebarSectionConfig[] = [
    ...
    },
    {
        id: 'agents',
        label: 'Agents',
        description: 'Configure AX Code agents, prompts, and permissions.',
        icon: "brain-ai-3",
    },
    {
        id: 'commands',
        label: 'Commands',
        description: 'Create and maintain custom slash commands for AX Code.',
        icon: "command",
    },
    {
        id: 'skills',
    ...
    },
    {
        id: 'settings',
        label: 'AX Code App',
        description: 'AX Code App settings: themes, fonts, and preferences.',
        icon: "settings-3",
    },
];
