---
title: Themes
description: Customize AX Code App with built-in and user-defined themes.
---

# Themes

AX Code App supports built-in themes and custom theme JSON files.
...
3. Open AX Code App, then go to **Settings -> Theme -> Reload themes**.
