...
Connect your GitHub account and AX Code Desktop can pull in issues and pull requests, start a session straight from one, and open or update PRs for you.

## Connect GitHub

1. Open **Settings → Git**.
2. Under GitHub, choose **Connect**. AX Code Desktop shows a link and a short code.
...
- pick an **issue** and AX Code Desktop names the branch after it and opens the session with the issue and its comments as the first message
...
From the **PR** tab in the [git view](/git/), you can create a pull request, update it, mark a draft as ready, or merge it. AX Code Desktop can generate the PR title and description from your changes.
