---
title: Temas
description: Personalize o AX Code App com temas integrados e definidos pelo usuário.
---

# Temas

O AX Code App oferece suporte a temas integrados e arquivos JSON de tema personalizados.
...
3. Abra o AX Code App e vá em **Settings -> Theme -> Reload themes**.
