---
title: Reverse Proxy
description: Configure AX Code App correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run AX Code App behind Nginx, Nginx Proxy Manager, Caddy, Cloudflare, or another reverse proxy.
