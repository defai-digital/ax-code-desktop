---
title: Reverse Proxy
description: Configure AX Code Desktop correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run AX Code Desktop behind Nginx, Nginx Proxy Manager, Caddy, or another reverse proxy.
...
If you place a CDN in front of your reverse proxy, be aware of double compression:

- AX Code Desktop compresses HTTP responses with gzip (threshold 1 KB).
- CDNs often compress responses by default.
