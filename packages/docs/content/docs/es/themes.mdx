---
title: Temas
description: Personaliza AX Code App con temas integrados y definidos por el usuario.
---

# Temas

AX Code App admite temas integrados y archivos JSON de tema personalizados.
...
3. Abre AX Code App y ve a **Settings -> Theme -> Reload themes**.
