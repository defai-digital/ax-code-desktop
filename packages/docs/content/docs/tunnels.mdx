---
title: Tunnels
description: Expose AX Code App safely for trusted workstation access.
---

# Tunnels

A tunnel is a public link to your AX Code App for controlled remote workstation access. Use `openchamber tunnel` to create one for a running instance.
