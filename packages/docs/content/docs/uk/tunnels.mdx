---
title: Тунелі
description: Безпечно відкрийте AX Code App для довірених робочих станцій.
---
...
Коли тунель піднято, `status` показує публічний URL. Відкривайте його лише на довіреній робочій станції.

Копіюйте згенероване посилання підключення лише в браузери довірених робочих станцій.
