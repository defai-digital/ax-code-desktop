---
title: Теми
description: Налаштуйте AX Code App за допомогою вбудованих і власних тем.
---

# Теми

AX Code App підтримує вбудовані теми та власні JSON-файли тем.
...
3. Відкрийте AX Code App, потім перейдіть до **Settings -> Theme -> Reload themes**.
